      ...
      <div className="card">
        <div className="card-body">
          ...
          <div className="row file-add-cta">
            <span>
              <button type="button" class="btn btn-info"><Link href="/dashboard/files/create" style={{color: "white", textDecoration: "none"}}><i className="fa fa-plus" /> Create New File Store</Link></button>
            </span>
            <span>
          ...
          {(filesLoading && userLoading && !fileStores?.length) ? <div style={{height: "100vh", textAlign: "center" }}>Loading...</div> : (
          <table className="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                {fileStores?.error?.message}</tr>
              :
              fileStores?.map((value) => {
                return (
              <tr key={value.fileStoreID}>
                <td> <input type="checkbox" value={value.fileStoreID} /> </td>
                ...
                <td> <i className="fa fa-cloud-upload" /> </td>
                <td> <i className="fa fa-unlock-alt" /> </td>
                <td> <i className="fa fa-pencil" />
                  <i className="fa fa-trash-o" style={{ marginLeft: "5px" }} />
                </td>
              </tr>)
              })}
            </tbody>
